...
class EmployeeViewModelTest {
    ...
    lateinit var employeeViewModel: GiphyViewModel
    lateinit var response: Response<PostModel>
...
//        response = Response.success(list)
        ...
        employeeViewModel = GiphyViewModel(testDispatcher, networkRepository)
        if (retrofit != null) {
            if (networkRepository != null) {
                Mockito.`when`(networkRepository.fetchData()).thenReturn(response)
            }
        }
